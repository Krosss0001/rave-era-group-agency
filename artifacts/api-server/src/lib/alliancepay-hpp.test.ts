...
} from "./alliancepay-hpp";

test("official HPP create-order payload includes required customer id and wallet methods", () => {
...
test("official HPP API uses the documented ECOM endpoint and auth headers", () => {
  assert.equal(
    ALLIANCEPAY_HPP_CREATE_ORDER_URL,
