...
const legalDetails = {
  uk: [
    ...
    "Платіжна сторінка: AlliancePay HPP. Онлайн-оплата активується лише після активації AlliancePay.",
  ],
  en: [
    ...
    "Hosted payment page: AlliancePay HPP. Online payment is activated only after AlliancePay activation.",
  ],
};
...
const sections = {
  uk: [
    ...
    ["2. Склад послуги та квитки", "SPORT - 2 500 грн: офлайн-доступ до конференції, експозони, нетворкінгу, спільноти Sport&Business Club, пакета учасника та фото/відео звіту. BUSINESS - 6 500 грн: SPORT-доступ плюс бізнес-lounge, зона спікерів, пріоритетний вхід, місця 1-4 рядів, матеріали спікерів, відеозапис і паркомісце. ONLINE - 1 000 грн: онлайн-трансляція та відеозапис події."],
    ["3. Порядок оплати", "Оплата здійснюється на захищеній платіжній сторінці AlliancePay HPP після активації AlliancePay. Сайт не приймає, не обробляє та не зберігає дані платіжних карток. Можливі статуси банку: SUCCESS - оплату підтверджено; FAIL - оплату відхилено або скасовано; PENDING - очікується остаточний статус; REQUIRED_3DS - потрібне підтвердження 3-D Secure. Перевірка callback/status виконується тільки на backend/server-side. Квиток видається тільки після SUCCESS."],
  ...
  en: [
    ...
    ["3. Payment Procedure", "Payment is made on the secure AlliancePay hosted payment page after AlliancePay activation. This site does not accept, process or store payment card data. Possible bank statuses: SUCCESS - payment confirmed; FAIL - payment declined or cancelled; PENDING - final status is pending; REQUIRED_3DS - 3-D Secure confirmation is required. Callback/status checks are performed only on the backend/server side. A ticket is issued only after SUCCESS."],
