...
const legalDetails = {
  uk: [
    ...
    "Банк-еквайр / платіжна сторінка: АТ «Альянс Банк» / AlliancePay HPP",
    "IBAN: буде додано після підтвердження реальних банківських реквізитів ФОП. Не активувати приймання платежів до додавання IBAN.",
  ],
  en: [
    ...
    "Acquiring bank / hosted payment page: JSC Alliance Bank / AlliancePay HPP",
    "IBAN: to be added after real FOP bank details are confirmed. Do not activate payment acceptance before the IBAN is added.",
  ],
};
...
const sections = {
  uk: [
    ...
    ["3. Порядок оплати", "Оплата здійснюється на захищеній платіжній сторінці AlliancePay HPP. Сайт не приймає, не обробляє та не зберігає дані платіжних карток. Можливі статуси банку: SUCCESS - оплату підтверджено; FAIL - оплату відхилено або скасовано; PENDING - очікується остаточний статус; REQUIRED_3DS - потрібне підтвердження 3-D Secure. Квиток видається тільки після SUCCESS."],
  ...
  en: [
    ...
    ["3. Payment Procedure", "Payment is made on the secure AlliancePay hosted payment page. This site does not accept, process or store payment card data. Possible bank statuses: SUCCESS - payment confirmed; FAIL - payment declined or cancelled; PENDING - final status is pending; REQUIRED_3DS - 3-D Secure confirmation is required. A ticket is issued only after SUCCESS."],
